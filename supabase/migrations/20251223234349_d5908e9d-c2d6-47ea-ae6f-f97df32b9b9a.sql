-- Add listing_type to messages so pushes can switch app mode even when property_id is NULL (e.g., admin messages)
ALTER TABLE public.messages
ADD COLUMN IF NOT EXISTS listing_type TEXT;

-- Update trigger_push_notification to read listing_type from messages when no property_id exists
