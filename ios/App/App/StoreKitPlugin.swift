...
/// StoreKit 2 plugin for Capacitor - handles iOS In-App Purchases
@objc(StoreKitPlugin)
public class StoreKitPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    public override func load() {
        print("[StoreKitPlugin] Plugin loaded and ready")
        ...
        return Task.detached {
            for await result in Transaction.updates {
                do {
                    ...
                    print("[StoreKitPlugin] Transaction update received: \(transaction.productID)")
                } catch {
                    print("[StoreKitPlugin] Transaction failed verification: \(error)")
                }
            }
        }
    }
    ...
    @objc func initialize(_ call: CAPPluginCall) {
        print("[StoreKitPlugin] Initialize called")
    ...
    @objc func getProducts(_ call: CAPPluginCall) {
        ...
        Task {
            do {
                ...
                print("[StoreKitPlugin] Fetched \(productsArray.count) products")
                call.resolve(["products": productsArray])
            } catch {
                print("[StoreKitPlugin] Failed to fetch products: \(error)")
    ...
    @objc func purchaseProduct(_ call: CAPPluginCall) {
        ...
        print("[StoreKitPlugin] Starting purchase for: \(productId)")
        ...
        Task {
            do {
                ...
                case .success(let verification):
                    ...
                    print("[StoreKitPlugin] Purchase successful: \(transaction.id)")
                    call.resolve([
                        "success": true,
                        "transactionId": String(transaction.id),
                        "productId": transaction.productID,
                ...
                case .userCancelled:
                    print("[StoreKitPlugin] Purchase cancelled by user")
                    call.resolve([
                        "success": false,
                        "cancelled": true
                    ])
                ...
                case .pending:
                    print("[StoreKitPlugin] Purchase pending")
                    call.resolve([
                        "success": false,
                        "pending": true
                    ])
                ...
                print("[StoreKitPlugin] Purchase failed: \(error)")
    ...
    @objc func restorePurchases(_ call: CAPPluginCall) {
        print("[StoreKitPlugin] Restoring purchases")
        ...
        Task {
            do {
                ...
                print("[StoreKitPlugin] Restored \(restoredTransactions.count) transactions")
                call.resolve([
                    "success": true,
                    "transactions": restoredTransactions
                ])
            } catch {
                print("[StoreKitPlugin] Failed to restore purchases: \(error)")
    ...
    @objc func getReceiptData(_ call: CAPPluginCall) {
        print("[StoreKitPlugin] Getting receipt/entitlements data")
        ...
        Task {
            ...
            print("[StoreKitPlugin] Found \(entitlements.count) entitlements")
            call.resolve([
                "success": true,
